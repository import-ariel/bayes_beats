...
6. [Datasets](#datasets)
    - [Image Dataset: 1-Million-Pairs-Image-Caption](#image-dataset-1-million-pairs-image-caption)
    - [Music Dataset: MTG-Jamendo](#music-dataset-mtg-jamendo)
    - [Data Preprocessing](#data-preprocessing)
7. [Model Architecture](#model-architecture)
    - [ACE-STEP Foundation](#ace-step-foundation)
    - [LoRA Fine-Tuning Approach](#lora-fine-tuning-approach)
    - [Diffusion & Deep Compression AutoEncoder](#diffusion--deep-compression-autoencoder)
    - [Linear Transformer for Musical Coherence](#linear-transformer-for-musical-coherence)
    - [Bayesian Prior over Latent Space](#bayesian-prior-over-latent-space)
        - [Variational Inference Layer](#variational-inference-layer)
...
8. [Mathematical Formulation](#mathematical-formulation)
    ...
    - [Bayesian Priors and Regularization](#bayesian-priors-and-regularization)
    - [Evidence Lower Bound (ELBO)](#evidence-lower-bound-elbo)
    - [Variational Inference Derivation](#variational-inference-derivation)
9. [Implementation Details](#implementation-details)
    - [Software Stack & Libraries](#software-stack--libraries)
    - [Training Procedure](#training-procedure)
    - [Hyperparameters](#hyperparameters)
    - [Fine-Tuning with Jamendo](#fine-tuning-with-jamendo)
    - [Music Generation Pipeline](#music-generation-pipeline)
    - [Visualization and Evaluation Tools](#visualization-and-evaluation-tools)
10. [Challenges & Solutions](#challenges--solutions)
    - [Challenge 1: Ambiguous Image-to-Audio Mapping](#challenge-1-ambiguous-image-to-audio-mapping)
    - [Challenge 2: Coherence vs. Diversity in Generated Music](#challenge-2-coherence-vs-diversity-in-generated-music)
    - [Challenge 3: Data Alignment and Preprocessing](#challenge-3-data-alignment-and-preprocessing)
    - [Challenge 4: Model Training Stability](#challenge-4-model-training-stability)
    - [Other Challenges & Mitigations](#other-challenges--mitigations)
11. [Results](#results)
    - [Qualitative Results: Sample Generations](#qualitative-results-sample-generations)
    - [Quantitative Metrics](#quantitative-metrics)
    - [User Study (if applicable)](#user-study-if-applicable)
...
15. [Appendix](#appendix)
    - [Figures & Technical Diagrams](#figures--technical-diagrams)
    - [Additional Mathematical Derivations](#additional-mathematical-derivations)
